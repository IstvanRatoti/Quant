...
public class Main
{
	...
	public static void printStuff(DBConnection dBConnection) throws SQLException
	{
		...
		for(Activity activity : actList)
		{
			...
			if (activity.getPlaceAndTimes() != null)
			{
				...
				{
					System.out.println("Place: " + placeAndTime.getPlace());
					System.out.println("Time and date: " + placeAndTime.getTimeAndDate().toString());
					System.out.println("Duration: " + placeAndTime.getDuration().toString());
					System.out.println("Schedule ID: " + placeAndTime.getScheduleId());
					System.out.println();
				}
			}
		}
	...
	public static void main(String[] args)
	{
		...
		byte schedId = 0;
		Activity actToStore = new Activity("inserted activity", "this one is from the java code", 0, "candyland", date, duration, schedId);
		actToStore.addPlaceAndTime(actToStore.new PlaceAndTime("neverland", date, duration2, schedId), false);
